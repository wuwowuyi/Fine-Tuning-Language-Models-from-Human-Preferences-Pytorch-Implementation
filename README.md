...
This repo is my rewrite in Pytorch 2.0 of [lm-human-preferences](https://github.com/openai/lm-human-preferences) which is Tensorflow v1 implementation of the paper [Fine-Tuning Language Models from Human Preferences](https://arxiv.org/abs/1909.08593) which is OpenAI’s original RLHF work from 2019. See [my notes on this paper](Paper.md), and also [a brief summary of other OpenAI's RLHF paper and DPO](https://github.com/wuwowuyi/direct-preference-optimization/tree/main). 
